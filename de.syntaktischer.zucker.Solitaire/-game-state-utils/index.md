---
title: GameStateUtils -
---
//[Solitaire](../../index.md)/[de.syntaktischer.zucker.Solitaire](../index.md)/[GameStateUtils](index.md)



# GameStateUtils  
 [jvm] object [GameStateUtils](index.md)   
...
| <a name="de.syntaktischer.zucker.Solitaire/GameStateUtils/load/#/PointingToDeclaration/"></a>[load](load.md)| <a name="de.syntaktischer.zucker.Solitaire/GameStateUtils/load/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>@[JvmStatic](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.jvm/-jvm-static/index.html)()  <br>  <br>fun [load](load.md)(): [GameState](../-game-state/index.md)?  <br><br><br>
| <a name="de.syntaktischer.zucker.Solitaire/GameStateUtils/save/#de.syntaktischer.zucker.Solitaire.GameState?/PointingToDeclaration/"></a>[save](save.md)| <a name="de.syntaktischer.zucker.Solitaire/GameStateUtils/save/#de.syntaktischer.zucker.Solitaire.GameState?/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>@[JvmStatic](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.jvm/-jvm-static/index.html)()  <br>  <br>fun [save](save.md)(gameState: [GameState](../-game-state/index.md)?)  <br><br><br>
