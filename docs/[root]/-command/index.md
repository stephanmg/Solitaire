...
title: Command -
---
//[Solitaire](../../index.md)/[[root]](../index.md)/[Command](index.md)
...
| <a name="/Command/execute/#/PointingToDeclaration/"></a>[execute](execute.md)| <a name="/Command/execute/#/PointingToDeclaration/"></a>[jvm]  <br>Content  <br>abstract fun [execute](execute.md)()  <br><br><br>
...
|  Name| 
|---|
| <a name="/Reset///PointingToDeclaration/"></a>[Reset](../-reset/index.md)
| <a name="/UndoableCommand///PointingToDeclaration/"></a>[UndoableCommand](../-undoable-command/index.md)
